        ...
        <div className="grid-2" style={{gap:'32px'}}>
          ...
          <div className="card" style={{padding:'36px'}}>
            ...
            <ul className="styled-list text-justify">
              ...
              <li>Extended abstracts (for poster sessions) must be <strong>800–1,200 words</strong> </li>
              <li>Submissions must present <strong>original, unpublished research</strong> </li>
              <li>Papers must include a structured abstract of <strong>200–300 words</strong> </li>
              <li>A minimum of <strong>5 relevant keywords</strong> </li>
              <li>All figures and tables must be <strong>high-resolution (300 dpi minimum)</strong> </li>
              <li>Authors must declare all <strong>conflicts of interest</strong> </li>
              <li>Research involving <strong>human subjects or animal studies</strong> </li>
              <li>Statistical analyses must report <strong>effect sizes, confidence intervals</strong></li>
              <li>Manuscripts must be written in <strong>academic English</strong>;</li>
            </ul>
          </div>
